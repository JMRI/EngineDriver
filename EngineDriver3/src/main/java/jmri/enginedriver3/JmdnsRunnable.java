...
//    Handler jmdnsRunnableHandler;
  ...
  private boolean startJmdnsListeners() {
    ...
    if (intAddr == 0) {  //must have a local address, else show error and don't start anything
      ...
      try {
        ...
        String deviceName = deviceAddr.toString().substring(1);        //strip off leading /  TODO: improve this
