...
public class ED3Fragment extends Fragment {

	@Override
	public void onAttach(Activity activity) {
//		Log.d(Consts.DEBUG_TAG, "in ED3Fragment.onAttach() for " + getName() + " (" + getNum() + ")" + " type " + getType());
...
//		Log.d(Consts.DEBUG_TAG, "in ED3Fragment.onResume() for " + getName() + " (" + getNum() + ")" + " type " + getType());
		super.onResume();
	}
	@Override
	public void onStart() {
//		Log.d(Consts.DEBUG_TAG, "in ED3Fragment.onStart() for " + getName() + " (" + getNum() + ")" + " type " + getType());
		super.onStart();
	}
	@Override
	public void onStop() {
...
//		super();
//	}
	protected static ED3Application mainapp; // hold pointer to mainapp
...
//		Log.d(Consts.DEBUG_TAG, "in ED3Fragment.onActivityCreated() for " + getName() + " (" + getNum() + ")" + " type " + getType());
		...
		mainapp=(ED3Application)getActivity().getApplication();  //set pointer to app
