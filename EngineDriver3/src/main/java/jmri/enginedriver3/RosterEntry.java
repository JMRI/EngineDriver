...
public class RosterEntry {
  ...
  final static int MAXFNNUM = 30;  //TODO: put this back to 28 when other issues are addressed
  ...
  protected ArrayList<String>   functionLabels = new ArrayList<String>();
  protected ArrayList<String>   functionNames = new ArrayList<String>();
  protected ArrayList<Boolean>  functionLockables = new ArrayList<Boolean>();
...
//    protected String _isShuntingOn="";
  ...
  public void setFunctionLabel(int fn, String label) {
    functionLabels.add(fn, label);
  }

  /**
   * Define name for a specific function, such as "F4"
   * @param fn function number, starting with 0
   */
  public void setFunctionName(int fn, String name) {
...
//		}
    functionLockables.add(fn, lockable);
  }
