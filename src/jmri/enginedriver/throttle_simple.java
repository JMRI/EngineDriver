...
public class throttle_simple extends throttle_base {
...
//    private View[] vVols; // volume indicators
...
//        for (int throttleIndex = 0; throttleIndex < NumThrottles; throttleIndex++) {
...
//        int i;
//        int index = -1;
////        int numThrottles = allThrottleIndices.length;
//
...
//            for (int throttleIndex = 0; throttleIndex < NumThrottles; throttleIndex++) {
//                if (savedInstanceState.getSerializable("dir" + throttleIndex) != null)
...
//
//        NumThrottles = Numeralise(prefs.getString("NumThrottles", "0"));
//
//        mainapp.numThrottles = NumThrottles;
//
...
//        }
//
//        setContentView(R.layout.throttle_simple);
//
...
//
        ...
        for (int i=3; i < mainapp.numThrottles; i++) {
            ...
            Button b = findViewById(R.id.Button_select_loco_3);
            switch (i) {
                case 4:
                    b = findViewById(R.id.Button_select_loco_4);
                    break;
                case 5:
                    b = findViewById(R.id.Button_select_loco_5);
                    break;
            }
            bSels[i] = b;
...
//        bSelG.setOnTouchListener(sfbt);
            ...
            try {
                ...
                b = findViewById(R.id.Right_speed_button_3);
                switch (i) {
                    case 4:
                        b = findViewById(R.id.Right_speed_button_4);
                        break;
                    case 5:
                        b = findViewById(R.id.Right_speed_button_5);
                        break;
                }
                bRSpds[i] = b;
                ...
                b = findViewById(R.id.Left_speed_button_3);
                switch (i) {
                    case 4:
                        b = findViewById(R.id.Left_speed_button_4);
                        break;
                    case 5:
                        b = findViewById(R.id.Left_speed_button_5);
                        break;
                }
                bLSpds[i] = b;
...
//            bLSpdG.setOnClickListener(asbl);
            ...
            b = findViewById(R.id.Button_fwd_3);
            switch (i) {
                case 4:
                    b = findViewById(R.id.Button_fwd_4);
                    break;
                case 5:
                    b = findViewById(R.id.Button_fwd_5);
                    break;
            }
            ...
            b = findViewById(R.id.Button_stop_3);
            switch (i) {
                case 4:
                    b = findViewById(R.id.Button_stop_4);
                    break;
                case 5:
                    b = findViewById(R.id.Button_stop_5);
                    break;
            }
            ...
            b = findViewById(R.id.Button_rev_3);
            switch (i) {
                case 4:
                    b = findViewById(R.id.Button_rev_4);
                    break;
                case 5:
                    b = findViewById(R.id.Button_rev_5);
                    break;
            }
            ...
            View v = findViewById(R.id.Speed_cell_3);
            switch (i) {
                case 4:
...
//        v.setOnTouchListener(fbtl);
            ...
            SeekBar s = findViewById(R.id.Speed_3);
            switch (i) {
                case 4:
...
//      displaySpeedSteps = false;
            ...
            switch (i) {
                case 3:
                    ...
                    vVols[i] = findViewById(R.id.Volume_indicator_3);
                    tvSpdLabs[i] = (TextView) findViewById(R.id.Speed_label_3);
                ...
                case 4:
                    ...
                    vVols[i] = findViewById(R.id.Volume_indicator_4);
                    tvSpdLabs[i] = (TextView) findViewById(R.id.Speed_label_4);
                ...
                case 5:
                    ...
                    vVols[i] = findViewById(R.id.Volume_indicator_5);
                    tvSpdLabs[i] = (TextView) findViewById(R.id.Speed_label_5);
...
//            enable_disable_buttons((char) (i + '0'));
//
//            if (TMenu != null) {
//                switch (i) {
//                    case 0:
...
//                        break;
//                    case 3:
//                        TMenu.findItem(R.id.EditConsist3_menu).setVisible(mainapp.consists[i].isMulti());
//                        break;
//                    case 4:
//                        TMenu.findItem(R.id.EditConsist4_menu).setVisible(mainapp.consists[i].isMulti());
//                        break;
//                    case 5:
//                        TMenu.findItem(R.id.EditConsist5_menu).setVisible(mainapp.consists[i].isMulti());
//                        break;
//                }
//            }
//
...
//                    fbtl = new function_button_touch_listener(func, (char)(whichThrottle + '0'), bt);
...
//        int heights[]; // height of throttle areas
...
//        for (int i=0; i < prefs.getInt("NumThrottle", 0); i++) {
...
//            setDisplayUnitScale((char) (i + '0'));
////            setDisplayUnitScale('T');
////            setDisplayUnitScale('G');
////            setDisplayUnitScale('S');
//
//            setDisplayedSpeed((char) (i + '0'), sbs[i].getProgress());  // update numeric speeds since units might have changed
...
//            if (mainapp.withrottle_version < 2.0 && NumThrottles != 1) {
//                NumThrottles = 2;
//            }

/*
todo: replace this section with widths
            if (NumThrottles == 1) {
                ...
                heights[4] = 0;
                heights[5] = 0;
            } else if (NumThrottles == 2 && !mainapp.consists[2].isActive()) {
                ...
                heights[4] = 0;
                heights[5] = 0;
            } else if (NumThrottles == 2 && !mainapp.consists[0].isActive()) {
                ...
                heights[4] = 0;
                heights[5] = 0;
            } else if (NumThrottles == 0 || NumThrottles == 3) {
...
//        for (int i=0; i < NumThrottles; i++) {
//            set_all_function_states((char) (i + '0'));
//        }
...
//            mainapp.sendMsg(mainapp.comm_msg_handler, message_type.RELEASE, "", (char)(i+'0'));   // release loco
//        }
...
//    public void promptForSteal(final String addr, final char whichThrottle) {
