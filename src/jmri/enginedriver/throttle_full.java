...
public class throttle_full extends throttle_base {
...
//
//    // current direction
//    private int[] dirs = {1,1,1};   // requested direction for each throttle (single or multiple engines)
//
...
////
////    private int mainapp.numThrottles = 0;
//
...
////    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        super.layoutViewId = R.layout.throttle_full;
...
//
//        mainapp.numThrottles = Numeralise(prefs.getString("mainapp.numThrottles", "0"));
//
...
//        }
//
//        setContentView(R.layout.throttle_full);
//
...
//            sfbt = new select_function_button_touch_listener((char)(i + '0'));
...
//                asbl = new arrow_speed_button_touch_listener((char)(i + '0'), "right");
...
//                asbl = new arrow_speed_button_touch_listener((char)(i + '0'), "left");
...
//                    break;
//            }
//            fbtl = new function_button_touch_listener(function_button.FORWARD, (char)(i + '0'));
...
//                    break;
//            }
//            fbtl = new function_button_touch_listener(function_button.STOP, (char)(i + '0'));
...
//                    break;
//            }
//            fbtl = new function_button_touch_listener(function_button.REVERSE, (char)(i + '0'));
...
//                    break;
//            }
//            fbtl = new function_button_touch_listener(function_button.SPEED_LABEL, (char)(i + '0'));
...
//            sbs[i] = s;
//            thl = new throttle_listener((char)(i + '0'));
...
//        set_function_labels_and_listeners_for_view('0');
//        set_function_labels_and_listeners_for_view('1');
//        set_function_labels_and_listeners_for_view('2');
    }
...
//            if (whichThrottle == '0' && mainapp.function_labels_0 != null && mainapp.function_labels_0.size() > 0) {
//                function_labels_temp = new LinkedHashMap<>(mainapp.function_labels_0);
//            } else if (whichThrottle == '1' && mainapp.function_labels_1 != null && mainapp.function_labels_1.size() > 0) {
//                function_labels_temp = new LinkedHashMap<>(mainapp.function_labels_1);
//            } else if (whichThrottle == '2' && mainapp.function_labels_2 != null && mainapp.function_labels_2.size() > 0) {
//                function_labels_temp = new LinkedHashMap<>(mainapp.function_labels_2);
            } else {
...
//
        if (screenHeight > throttleMargin) { // don't do this if height is invalid
            ...
            if (mainapp.numThrottles == 1) {
                ...
                heights[1] = 0;
                heights[2] = 0;
            } else if (mainapp.numThrottles == 2 && !mainapp.consists[1].isActive()) {
